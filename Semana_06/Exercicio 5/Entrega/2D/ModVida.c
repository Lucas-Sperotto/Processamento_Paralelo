...
#include "mpi.h"
	...
	//                O representa celula morta
	//				PARA casos unidimensionais
	//*************************************************************
	...
	//                X representa celula viva
	//                O representa celula morta
	//				PARA casos bidimensionais, cria-se um domínio compreto 
	//				e mestre recebe trechos de cada processo e imprime
	//*************************************************************
